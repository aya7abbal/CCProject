...
def visualization():
    ...
    spending_by_income = px.bar(
        filtered_data.groupby("INCOME_DESC")["SPEND"].sum().reset_index(),
        x="INCOME_DESC", y="SPEND", title="Spending by Income Category", color="INCOME_DESC"
    )
    ...
    spending_by_income_json = spending_by_income.to_json()
    ...
    return render_template(
        ...
        spending_by_income_json=spending_by_income_json,
