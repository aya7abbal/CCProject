...
# Load datasets (make sure to replace the placeholders with actual file paths)
transactions = pd.read_csv("/actual/path/to/cleaned_transactions.csv")
households = pd.read_csv("/actual/path/to/cleaned_households.csv")
products = pd.read_csv("/actual/path/to/cleaned_products.csv")
