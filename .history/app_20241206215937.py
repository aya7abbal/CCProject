...
# Load datasets
transactions = pd.read_csv("/path/to/cleaned_transactions.csv")
households = pd.read_csv("/path/to/cleaned_households.csv")
products = pd.read_csv("/path/to/cleaned_products.csv")
...
def visualization():
    ...
    loyalty_member = request.form.get("loyalty_member")  # This field is not in your datasets
    ...
    # Loyalty member filter is not applicable unless you have such a column in the dataset
